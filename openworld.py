...
def TogglePlatform():
	...
	platform.runAction(vizact.moveTo(pos,speed=10.0))
...
def FallAction():
	...
	flash_quad.runAction(vizact.call(blurEffect.setDistance,vizact.mix(500,0,time=2.5)),pool=1)
